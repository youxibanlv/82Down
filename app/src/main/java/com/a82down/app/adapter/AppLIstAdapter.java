...
//            holder.tv_time = (TextView) convertView.findViewById(R.id.tv_time);
            ...
            App app = (App) list.get(position);
        x.image().bind(holder.iv_app_icon,app.getApp_logo());
...
//        long update = Long.getLong(app.getApp_update_time(),0);
//        holder.tv_time.setText("更新时间："+ TimeUtil.longToDateStr(update,"yyyy-MM-dd"));
